    ...
    <Card className="border-border">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4 text-center">
          <div>
            <div className="text-2xl font-bold text-primary">${totalDonated.toLocaleString()}</div>
            <div className="text-sm text-muted-foreground">Total Donated</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-accent">{projectsSupported}</div>
            <div className="text-sm text-muted-foreground">Projects Supported</div>
          </div>
        </div>
        
        <div className="text-center">
          <div className="text-2xl font-bold text-success">{impactScore}%</div>
